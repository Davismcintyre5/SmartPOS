...
export default function AIChatScreen() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (res.success) {
        const reply = res.data?.reply || res.reply || "I couldn't process that.";
...
const styles = StyleSheet.create({
  ...
  botIcon: { width: 38, height: 38, borderRadius: 12, backgroundColor: "#3b82f6", alignItems: "center", justifyContent: "center" },
  ...
  sendBtn: { backgroundColor: "#3b82f6", width: 42, height: 42, borderRadius: 21, alignItems: "center", justifyContent: "center" },
